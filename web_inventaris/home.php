...
if(isset($_POST['add_to_cart'])){
   ...
   if($check_cart_numbers->rowCount() > 0){
      $message[] = 'Sudah ada di Tambahkan';
   }else{
...
<div class="home-bg">
   ...
   <section class="home">
      ...
      <div class="content">
         ...
         <a href="https://g.co/kgs/sdACzZL" class="btn">Maps</a>
      </div>
...
<section class="home-category">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <h3>Asinan/Gorengan</h3>
         <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Exercitationem, quaerat.</p>
         <a href="category.php?category=Asinan/Gorengan" class="btn">Asinan/Gorengan</a>
      </div>
      ...
      <div class="box">
         ...
         <h3>Bolu</h3>
         <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Exercitationem, quaerat.</p>
         <a href="category.php?category=Bolu" class="btn">Bolu</a>
      </div>
      ...
      <div class="box">
         ...
         <h3>Kue Basah</h3>
         <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Exercitationem, quaerat.</p>
         <a href="category.php?category=Kue Basah" class="btn">Kue Basah</a>
      </div>
      ...
      <div class="box">
         ...
         <h3>Kue Kering</h3>
         <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Exercitationem, quaerat.</p>
         <a href="category.php?category=Kue Kering" class="btn">Kue kering</a>
      </div>
...
<section class="products">
   ...
   <form action="" class="box" method="POST">
      ...
      <input type="submit" value="Tambahkan" class="btn" name="add_to_cart">
   </form>
   <?php
      }
   }else{
